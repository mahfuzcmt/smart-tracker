...
define(['app'], function (app) {
	...
	var ticketCountController = function (growl, $routeParams, $rootScope, $scope, _, constantService, $filter, navigationService, authorizationService, localStorageService,
		...
		$scope.exportData = function (param) {
			...
			window.open(constantService.baseUrl+"/report/exportTicketCountReport"+paramString);
		};
	...
	app.register.controller('ticketCountController', ['growl', '$routeParams', '$rootScope', '$scope', '_', 'constantService', '$filter', 'navigationService', 'authorizationService',
