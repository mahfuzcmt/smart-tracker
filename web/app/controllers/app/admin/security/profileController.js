...
define(['app'], function (app) {
	...
	var profileController = function ( $scope, apiService, navigationService, $upload, localStorageService,
		...
		var loadUserInfo = function () {
    		...
    		promis = apiService.loadData('userProfile/'+$scope.userInfo.userID);
    ...
    app.register.controller('profileController', ['$scope', 'apiService', 'navigationService', '$upload',
