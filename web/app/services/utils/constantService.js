...
define(['app'], function (app) {
    ...
    var constantService = function ($rootScope, $cookieStore) {
        ...
        this.tenantId = 'dgagri-1';
        this.tracker_tenantId = 'tenant-1';

        this.baseUrl = 'http://localhost:8080/';
        //this.tracker_baseUrl = 'http://localhost:8888/';
        this.tracker_baseUrl = 'http://45.86.70.142:8080/st/';

        //this.baseUrl = 'http://45.32.38.28:8080/v3/';
        //this.baseUrl = 'http://148.72.214.110:8080/st/';
       //this.baseUrl = 'http://45.32.38.28:8080/st-demo/';
